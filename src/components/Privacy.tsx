        ...
        <div className="space-y-6 text-gray-700">
          <section>
            ...
            <p>
              ...
              <strong>Belangrijk:</strong> Wij slaan deze gegevens niet op op onze servers of systemen. Uw gegevens worden uitsluitend gebruikt om uw
              vraag of verzoek te behandelen.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:lanniewebdesign@gmail.com" className="text-blue-600 underline">
