      ...
      <div className="w-full">
        <div className="grid w-full justify-center sm:flex sm:justify-between md:grid-cols-1">
          <div className="text-center">
            <h1 className="archi text-white">{companyName.toLocaleLowerCase()}</h1>
          </div>
          <div className="grid grid-cols-3 gap-4 sm:mt-4 sm:grid-cols-3 sm:gap-6">
            <div>
              <Footer.Title title="Over ons" className="text-white"/>
              <Footer.LinkGroup col>
                <Footer.Link href="/#about" className="text-white">{companyName}</Footer.Link>
              </Footer.LinkGroup>
            </div>
            <div>
              <Footer.Title title="Volg Ons" className="text-white"/>
              <Footer.LinkGroup col>
                <Footer.Link href="https://www.linkedin.com/in/milan-mareels-58b472265/" target="blank" className="text-white">
                  Linkedin
                </Footer.Link>
              </Footer.LinkGroup>
            </div>
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link href="/privacy" className="text-white">Privacy Policy</Footer.Link>
              </Footer.LinkGroup>
            </div>
          </div>
        </div>
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between text-center sm:text-left">
          <Footer.Copyright href="#" by={companyName} year={new Date().getFullYear()} className="text-white"/>
