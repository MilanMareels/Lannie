      ...
      <div className="pt-10 flex justify-center items-center flex-col gap-5">
        ...
        <div className="text-white max-w-[700px] m-auto text-center p-5">
          <p>
            ...
            bij het realiseren van een professionele en gebruiksvriendelijke
            website. Of je nu een eenvoudige website nodig hebt of op zoek bent
            naar een meer uitgebreide oplossing met extra functionaliteiten, ik
            bied de juiste ondersteuning om jouw online aanwezigheid te
            versterken. Neem gerust contact op voor meer informatie of om te
            bespreken welk pakket het beste bij jouw behoeften past!
          </p>
        </div>
      </div>
